...
# Database: sprint
# Generation Time: 1939-06-05 17:26:58 +0000
# ************************************************************
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `remember_token`, `created_at`, `updated_at`, `status`, `address`, `contact`)
VALUES
	(1,'nick','qaz@mail.com','$2y$10$ayj/zuO9SVtzuy9c85TTYeiiCtLoUITqLPyZvnyF/K5PPuAZ4/jx6',NULL,'2017-08-26 20:59:21','2017-08-26 20:59:21','b',NULL,NULL),
	(2,'nick','nick@mail.com','$2y$10$J92rbcTGLCH9s2Bz1.EuZ.BHICocDYHohUTBjbnV65ns1GNO.n2ny','OCqaEWHcgK8PzHd1SljN9OjmM4zq5fX95EVnV19qO4MzBsMX3GZeZFw6LCiM','2017-08-26 22:17:08','2017-08-26 22:17:08','b','Better Hope, Georgetown, Guyana',2200854),
	(3,'dana','dana@gmail.com','$2y$10$du.4neIt4FEGNjii4tgtuenyNQnx4ou/U5JJ3LCBvmYR9MS9ocIgy',NULL,'2017-08-26 22:29:03','2017-08-26 22:29:03','b','berbice',6507279);
